...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FormGenerator/FormGenerator.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MediaViewer/MediaViewer.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Vanguard/Vanguard.framework"
