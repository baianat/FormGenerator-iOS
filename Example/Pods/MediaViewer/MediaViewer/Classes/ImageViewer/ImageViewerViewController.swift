...
extension ImageViewerViewController {
    ...
    private func addImageViewToViewsHierarchy() {
        ...
        blurredImageView.centerYAnchor.constraint(equalTo: view.centerYAnchor).isActive = true
        blurredImageView.centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
